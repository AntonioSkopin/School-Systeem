...
<body>
    ...
    <div class="main-content">
        ...
        <a href="gezondeDocenten_pagina.php"><img class="back-arrow" src="../../Images/arrow.png" alt="Back arrow"></a>
        ...
        <div class="docenten-info">
            ...
            ?>
            <form method="post">
                <input type="submit" name="meldZiek" value="Meld ziek">
            </form>
            <?php
                if (isset($_POST["meldZiek"]))
                {
                    $meldZiek = new Queries();
                    $meldZiek->meldDocentZiek();
                }
            ?>
        </div>
        <!-- Container voor de info van de docent -->
